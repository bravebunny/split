...
export default class {
  constructor () {
    ...
    this.stonesInterval = random(200, 500)
    this.loversInterval = random(300, 500)
  ...
  update (x, y, state) {
    ...
    if (x % this.stonesInterval === 0) {
      this.entities.push(new Stone(this, startX + (300 * this.scale), startY, this.scale))
    }

    if (x % this.loversInterval === 0) {
      this.entities.push(new Lover(this, startX + (300 * this.scale), startY, this.scale))
    }
